<template>
    <v-app id="inspire">
        ...
        <!-- Top bar -->
        <v-app-bar>
            <v-app-bar-nav-icon variant="text" @click.stop="displayFloating = !displayFloating" />
        ...
        <!-- Left Bar -->
        <v-navigation-drawer v-model="displayFloating" floating>
            <v-list>
                ...
                <v-list-item v-if="isMobile">
                    <v-btn variant="text" block @click="displayFloating = false">
                        &#60;&#60; Hide
                    </v-btn>
                </v-list-item>
        ...
        <!-- Main content -->
        <v-main>
            <v-skeleton-loader type="article" v-show="loading" />
